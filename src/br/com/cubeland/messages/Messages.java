...
public class Messages {
    ...
    public static void finalKillMessage(Player player, Player killer) {
        Teams playerTeam = Teams.getTeam(player);
        Teams killerTeam = Teams.getTeam(killer);
        String message = translateColorCodes(String.format("%s%s &efoi eliminado da partida por %s%s&e.", playerTeam.getColor(), player.getName(), killerTeam.getColor(), killer.getName()));
